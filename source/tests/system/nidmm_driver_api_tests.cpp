...
TEST_F(NiDmmDriverApiTest, ConfiguredTrigger_ConfiguresSuccessfully)
{
  ...
  request.set_trigger_delay_mapped(dmm::TriggerDelays::TRIGGER_DELAYS_NIDMM_VAL_AUTO_DELAY_ON);  // TODO: Figure out why it's mapped instead of just trigger_delay
