...
ConfigureFrequencyVoltageRangeResponse configure_frequency_voltage_range(const StubPtr& stub, const nidevice_grpc::Session& vi, const double& voltage_range);
...
ConfigureOffsetCompOhmsResponse configure_offset_comp_ohms(const StubPtr& stub, const nidevice_grpc::Session& vi, const pb::int32& offset_comp_ohms);
...
ConfigurePowerLineFrequencyResponse configure_power_line_frequency(const StubPtr& stub, const nidevice_grpc::Session& vi, const double& power_line_frequency_hz);
...
ConfigureSampleTriggerSlopeResponse configure_sample_trigger_slope(const StubPtr& stub, const nidevice_grpc::Session& vi, const pb::int32& sample_trigger_slope);
