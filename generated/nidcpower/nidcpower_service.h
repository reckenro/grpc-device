...
private:
  ...
  std::map<std::int32_t, double> nidcpowerreal64attributevaluesmapped_input_map_ { {1, 50.0f},{2, 60.0f}, };
  std::map<double, std::int32_t> nidcpowerreal64attributevaluesmapped_output_map_ { {50.0f, 1},{60.0f, 2}, };
